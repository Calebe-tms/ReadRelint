...
| 0103 | Correção Pendente — `get_participant_dossier()` Sem `return` no Caminho de Sucesso | Aceita | [0103-correcao-pendente-return-ausente-dossie-participante.md](./0103-correcao-pendente-return-ausente-dossie-participante.md) |
...
| 0107 | Avatares na Aba Participantes via Galeria do Gerenciador de Pessoas | Aceita | [0107-avatares-participantes-gerenciador-pessoas.md](./0107-avatares-participantes-gerenciador-pessoas.md) |
